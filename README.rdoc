...
The app requires authentication. You can either login with your Google account, Github account, or simply create a user account.
...
You can also browse the orders, merchants, items, and purchasers lists using the top nav.
